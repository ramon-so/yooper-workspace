      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center" style="background: #FFF">
            <img style="max-width:100%" src="https://admin.yooper.com.br/images/yooper-dark.png"/>
          ...
          <div class="card-body">
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" autofocus="true" placeholder="{{ __('Email...') }}" value="{{ old('email', '@yooper.com.br') }}" required>
              </div>
              @if ($errors->has('email'))
