...
<?php                                    
    ...
    $banners = json_decode(htmlspecialchars_decode($e->banners_json));
    $produtos = json_decode(htmlspecialchars_decode($e->produtos_json));                                
?>
...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <br>
        @include('crm.email-marketing.headers.'.$pasta_nome.'.header')

        @include('crm.email-marketing.modelos.modelo-'.$e->modelo_id)
        @include('crm.email-marketing.footers.'.$pasta_nome.'.footer')
{{-- modelo --}}
<br>
</body>
