...
<head> 
	<meta charset="utf-8">
	<title>E-mail Marketing - {{ $e->nome_campanha }} - {{ $e->nome }}</title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
</head>
	<p style="display:none;">{{ $e->previa }}</p>
	...
	<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<br>
		<!-- Save for Web Slices (mailmkt_kit_embelleze.png) -->
		<table align="center" id="Tabela_01" width="600" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<a href="{{ $e->link }}"
						onmouseover="window.status='logo';  return true;" onmouseout="window.status='';  return true;">
						<img style="display: block;" align="absmiddle"
							src="https://email-marketing.yooper.com.br/email/{{ $e->config_nome_pasta_emkt }}/email-marketing-{{ $e->numero_pasta }}/{{ $e->imagem_email }}"
							width="600" border="0" alt="banner"></a>
				</td>
			</tr>
		</table>
