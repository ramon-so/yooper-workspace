...
<body class="{{ $class ?? '' }}">
    ...
    <script src="{{ asset()
            }}material/js/core/bootstrap-material-design.min.js"></script>
    <script src="{{ asset()
            }}material/js/plugins/perfect-scrollbar.jquery.min.js"></script>
    ...
    <script src="{{ asset()
            }}material/js/plugins/jquery.bootstrap-wizard.js"></script>
    <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
    <script src="{{ asset()
            }}material/js/plugins/bootstrap-selectpicker.js"></script>
    <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
    <script src="{{ asset()
            }}material/js/plugins/bootstrap-datetimepicker.min.js"></script>
    <!--  DataTables.net Plugin, full documentation here: https://datatables.net/  -->
    <script src="{{ asset()
            }}material/js/plugins/jquery.dataTables.min.js"></script>
