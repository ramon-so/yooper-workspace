...
@section('titulo', 'Yooper | Status Processo Seletivo')
@section('pagina', 'Cadastro Status de Processo Seletivo')
...
<div class="main-content animate__animated animate__fadeIn animate__slow">
    <div class="container-fluid">
        ...
        <div class="col-12 p-0 d-block d-md-flex justify-content-end
             ...
             @include('layouts.parametros.partials.parametros-status-processo-seletivo')
        ...
        <div class="row mb-5 mt-5">
            <div class="col-12 col-lg-6 mb-4 mb-lg-0" id="cadastro_sps">
                <div class="card shadow">
                    ...
                    <div class="card-body bg-secondary">
                        @include('layouts.parametros.partials.criar-status-processo-seletivo')
                    </div>
                </div>
            </div>

            <div class="col-12 col-lg-6 mb-4 mb-lg-0" hidden id="alteracao_sps">
                <div class="card shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center justify-content-lg-start position-relative">
                            ...
                            <div id="icone-cancelar" data-toogle="tooltip" onclick="toggleInputSpsClosed()"
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <div class="form-group p-0">
                           <input type="text" class="form-control" autofocus id="input_status_processo_seletivo_editar" name="nome" placeholder="Nome do status">
                           <input type="text" hidden class="form-control" id="input_sps_id" name="sps_id" >
                        </div>
                        <div class="text-center">
                            <button onclick="editar_sps()" class="btn btn-primary mt-4">Salvar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 tabela-cadastrados">
                <div class="card">
                    ...
                    <div class="table-responsive barra">
                        @include('layouts.parametros.partials.status-processo-seletivo')
                    </div>
                </div>
            </div>
        </div>
