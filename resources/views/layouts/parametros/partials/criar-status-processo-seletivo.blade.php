<form id="sps_criar" method="post" action="{{ route('criar_status_processo_seletivo') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group p-0">
        ...
        <input type="text" class="form-control" autofocus id="status_processo_seletivo" name="nome"
