...
@section('titulo', 'Yooper | Cadastrar Usuários')
@section('pagina', 'Cadastrar Usuários')
                ...
                <div class="card shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center justify-content-lg-start">
                            <h3 class="mt-1 mb-1 ml-2 text-center text-lg-left">Cadastro de usuário</h3>
                        </div>
                    </div>
                    <div class="card-body bg-secondary">

                        @include('layouts.usuarios.partials.cadastro-usuario')
            ...
            <div class="col-lg-6 tabela-cadastrados">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        ...
                        @include('layouts.usuarios.partials.ultimos-cadastrados')
