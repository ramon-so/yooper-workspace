<div class="solicitacoes-cadastradas-modal" id="parecer-modal-{{$candidato->candidato_id}}">
    <div class="col-lg-5 solicitacao-processo-seletivo-box">
        <img src="{{ asset('assets') }}/img/icons/close.webp" class="close-modal"
            id="close-modal-adicionar-parecer-{{$candidato->candidato_id}}"
            onclick="parecerFechar({{$candidato->candidato_id}})">
        <div class="card shadow col-12 p-0 m-0">
            ...
            <div class="card-body bg-secondary">
                ...
                <form method="post" action="/processo-seletivo/{{$processo->processo_id}}/candidato/{{$candidato->candidato_id}}/adicionar-parecer"
                    ...
                    <div clas="form-group">
                        ...
                        <input type="number" hidden name="processo_id" value="{{$processo->processo_id}}">
