<div class="adicionar-candidato-modal" id="adicionar-candidato-modal-banco">
    <div class="col-lg-5 adicionar-candidato-seletivo-box">
        <img src="{{ asset('assets') }}/img/icons/close.webp" class="close-modal" id="close-modal-candidato" onclick="cadastrarCandidatoFechar()">
        <div class="card shadow col-12 p-0 m-0">
            <div class="card-header bg-white border-0">
                <div class="row align-items-center justify-content-center justify-content-lg-start">
                    <h3 class="mt-1 mb-1 ml-2 text-center text-lg-left">Adicionar candidato
                    </h3>
                </div>
            </div>
            <div class="card-body bg-secondary">
                <form method="post" action="/banco-de-candidatos/cadastrar-candidato" enctype="multipart/form-data" id="cadastrarCandidatoForm">
                @csrf
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="input-telefone-cadastrar">Telefone</label>
                        <input type="text" required name="telefone" class="form-control" id="input-telefone-cadastrar" placeholder="Telefone" value="">
                    </div>
                    <div class="form-group">
...
<script>
    $("#input-telefone-cadastrar").mask("(99) 99999-9999");
</script>
