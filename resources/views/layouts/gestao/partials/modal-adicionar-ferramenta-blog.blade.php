<div class="adicionar-candidato-modal" id="adicionar-ferramenta-blog">
    <div class="col-lg-5 adicionar-candidato-seletivo-box">
        <img src="{{ asset('assets') }}/img/icons/close.webp" class="close-modal" onclick="fechar_modal_ferramenta_blog()" id="close-modal-editar-contrato">
        <div class="card shadow col-12 p-0 m-0">
            <div class="card-header bg-white border-0">
                <div class="row align-items-center justify-content-center justify-content-lg-start">
                    <h3 class="mt-1 mb-1 ml-2 text-center text-lg-left">Adicionar ferramenta BLOG
                    </h3>
                </div>
            </div>
                ...
                <form action="{{ route('adicionar_ferramenta') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" id="form-content-alocar">
                            <input type="hidden" name="contrato_id" id="contrato_id_ferramenta_blog">
                            <input type="hidden" name="cliente_id" id="cliente_id_ferramenta_blog">
                        </div>
                        <div class="row">
